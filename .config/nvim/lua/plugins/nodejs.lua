...
-- Node.js development specific plugins for LazyVim (Stable Version)
...
return {
  ...
  -- Enhanced file explorer (using LazyVim's built-in neo-tree)
  -- Note: LazyVim already includes neo-tree, so we just configure it
  {
